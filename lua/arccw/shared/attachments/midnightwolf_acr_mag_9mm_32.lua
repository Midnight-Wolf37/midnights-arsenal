...
att.Hook_GetShootSound = function(wep, fsound)
    if fsound == "weapons/arccw/midnightwolf/acr/fire.ogg" then return "weapons/arccw/midnightwolf/acr/fire_9mm.wav"
    elseif fsound == "weapons/arccw/midnightwolf/acr/fire_supp.ogg" then return "weapons/arccw/midnightwolf/acr/fire_supp_9mm.wav"
